...
hmrServer.use(webpackDevMiddleware(clientCompiler, {
    ...
    writeToDisk: true,//по умолчанию webpackDevMiddleware не пишет на диск, но чтобы раздавать client.js из папки static и hotupdate нашему express серверам а не webpack-dev-serverам, нам нужно их писать.
